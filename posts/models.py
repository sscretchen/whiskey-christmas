...
class Category(models.Model):
    ...
    def post_count(self):
        """Point to the Post model 'category' field and see how many entries use a specific category. Then display that number on the side bar for each relevant page"""
...
class Post(models.Model):
    ...
    def comment_count(self):
        # comments comes from the related_name in the Comment model
